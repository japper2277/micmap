...
- Post URL: https://www.instagram.com/mharriscomedy/p/DUoPf5Dj228/
- Screenshot: `/home/runner/work/micmap/micmap/logs/ig-post-shayayanyc-2.png`
- Reasons: extracted risky fields differ from current mic record
- Risky diffs:
  - startTime: `7:00 PM` -> `6p-midnight`
  - name: `Pure Chaos` -> `unserious pool`
  - host: `PURE CHAOS (@purechaoscomedy)` -> `mharriscomedy`
  - cost: `$5` -> `$5 unlimited +`
...
- 1. @laughingbuddhacomedy 10:30 PM Mic Friday 10:30 PM
  Signup: See 'REGISTER' button (link not accessible)
